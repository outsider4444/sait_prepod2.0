...
urlpatterns = [
    ...
    path('administrator/pp0201_lectures_list/pp0201_new_lecture', views.admin_pp0201_New_lecture, name="admin-pp0201_new_lecture"),
    path('administrator/pp0102_lectures_list/pp0102_new_lecture', views.admin_pp0102_New_lecture, name="admin-pp0102_new_lecture"),
    ...
    path('administrator/pp0201_practices_list/pp0201_new_practice', views.admin_pp0201_New_practice, name="admin-pp0201_new_practice"),
    path('administrator/pp0102_practices_list/pp0102_new_practice', views.admin_pp0102_New_practice, name="admin-pp0102_new_practice"),
